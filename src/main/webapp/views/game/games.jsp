    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel2">Registro de los videojuegos</h5>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-success" onclick="create()">Agregar Nuevo Videojuego</button>
